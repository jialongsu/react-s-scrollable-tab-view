...
var DefaultTabBar = (_temp = _class = function (_PureComponent) {
    (0, _inherits3.default)(DefaultTabBar, _PureComponent);

    function DefaultTabBar(props) {
        (0, _classCallCheck3.default)(this, DefaultTabBar);

        var _this = (0, _possibleConstructorReturn3.default)(this, (DefaultTabBar.__proto__ || (0, _getPrototypeOf2.default)(DefaultTabBar)).call(this, props));
        ...
        value: function _renderTabItems() {
            ...
            return tabAry.map(function (item, i) {
                ...
                if (activeTab == -1 || activeTab == i) {
                    itemCls = _styles2.default.default_activeItem;
                    textStyle.color = activeTextColor;
                    itemActiveStyle = textStyle;
                } else {
                    itemCls = _styles2.default.default_item;
                    itemActiveStyle = {};
                }
